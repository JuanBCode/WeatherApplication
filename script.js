...
var coords = {
  //to store latitute and longitude
  lat: 0.0,
  lon: 0.0,
};
...
$(function () {
  ...
  function getTimetoUseInAPI() {
    ...
    if (currTime < "03:00:00") useTime = "00:00:00";
    else if (currTime < "06:00:00") useTime = "03:00:00";
    else if (currTime < "09:00:00") useTime = "06:00:00";
    else if (currTime < "12:00:00") useTime = "09:00:00";
    else if (currTime < "15:00:00") useTime = "12:00:00";
    else if (currTime < "18:00:00") useTime = "15:00:00";
    else if (currTime < "21:00:00") useTime = "18:00:00";
    else useTime = "03:00:00";
  ...
  function getCityWeather(city, save) {
    ...
    fetch(geoCordURL)
      ...
      .then(function (data) {
        //data returned from fetch call with geoCordURL
              ...
              for (var x = 1; x < 6; x++) {
                ...
                while (i < data.list.length) {
                  if (useDateTime === data.list[i].dt_txt) {
                    ...
                    line2.text(
                      "Temp: " + data.list[i].main.temp_max + "\u00B0F"
                    );
                    dayEl.append(line2);
  ...
  function getLastSearchWeather() {
    ...
    if (savedCities.length === 0) {
      ...
      localStorage.setItem("savedCities", JSON.stringify(savedCities));
      curCity = lastCity;
    } else lastCity = savedCities[savedCities.length - 1];
